...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate, UIScrollViewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        // function that disable the share button if no picture has been selected
        shareEnable()
  ...
  @objc  func keyboardWiShow(_ notification:Notification) {
    ...
    func save() {
            // Create the meme
        _ = Meme(topText: topTextField.text!, bottomText: bottomTextField.text!, originalImage: imageV.image!, memedImage: generateMemedImage())
    }
